...
describe('spell library UI structure', () => {
  ...
  it('uses a full-width scrollable list with editing in a modal dialog', () => {
    ...
    expect(component).toContain('className="candidate-memory-reveal"');
    expect(component).toContain('candidate-memory-page-left');
    expect(component).toContain('candidate-memory-page-right');
    expect(component).toContain('candidate-memory-history-line');
    ...
    expect(styles).toContain('@keyframes candidate-memory-page-left');
    expect(styles).toContain('@keyframes candidate-memory-page-right');
    expect(styles).toContain('@keyframes candidate-memory-history-flow');
    expect(styles).toContain('@keyframes candidate-memory-search');
    expect(styles).toContain('@keyframes candidate-memory-copy-lead');
    expect(styles).toContain('@keyframes candidate-memory-copy-tail');
    expect(styles).toContain('@keyframes candidate-memory-spark');
