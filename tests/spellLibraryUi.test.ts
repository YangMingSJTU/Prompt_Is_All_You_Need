...
describe('spell library UI structure', () => {
  ...
  it('uses a full-width scrollable list with editing in a modal dialog', () => {
    ...
    expect(bookScene).toContain('new THREE.OrthographicCamera');
    expect(bookScene).not.toContain('new THREE.PerspectiveCamera');
    expect(bookScene).not.toContain('RoundedBoxGeometry');
    expect(bookScene).not.toContain('CylinderGeometry');
    expect(bookScene).toContain('new THREE.MeshBasicMaterial');
    expect(bookScene).not.toContain('new THREE.MeshPhysicalMaterial');
    expect(bookScene).not.toContain('new THREE.MeshStandardMaterial');
    expect(bookScene).toContain('renderer.shadowMap.enabled = false');
    expect(bookScene).not.toContain('castShadow = true');
    expect(bookScene).not.toContain('receiveShadow = true');
    expect(bookScene).not.toContain('new THREE.ShadowMaterial');
    expect(bookScene).toContain('createHoverGlowTexture');
    expect(bookScene).toContain("createBackingTexture('left')");
    expect(bookScene).toContain("createBackingTexture('right')");
    expect(bookScene).toContain('createBookMarkTexture');
    expect(bookScene).toContain('createFourPointStarGeometry');
    expect(bookScene).toContain('new THREE.SpriteMaterial');
    expect(bookScene).toContain("createPageGeometry('left')");
    expect(bookScene).toContain("createPageGeometry('right')");
    expect(bookScene).toContain('const leftWing = new THREE.Group()');
    expect(bookScene).toContain('const rightWing = new THREE.Group()');
    expect(bookScene).toContain('new THREE.CanvasTexture');
    expect(bookScene).toContain('createArcaneBadge');
    ...
    expect(bookScene).not.toContain('setPageCurl');
    expect(bookScene).not.toContain('setTurningPageShape');
    expect(bookScene).toContain('getIconBookRevealProgress');
    expect(bookScene).toContain('getIconMarkOpacity');
    expect(bookScene).toContain('getPageTurnProgress');
    expect(bookScene).toContain('getIconBookTransitionPose');
    expect(bookScene).toContain('nextLeftSurface');
    expect(bookScene).toContain('nextRightSurface');
    expect(bookScene).toContain('createPageTransitionMaterial');
    expect(bookScene).toContain('new THREE.ShaderMaterial');
    expect(bookScene).toContain('float sweepEdge = mix(1.08, -0.08, uProgress)');
    expect(bookScene).toContain('float reveal = smoothstep');
    expect(bookScene).toContain('leftPageMaterial.uniforms.uProgress.value = pageTurn');
    expect(bookScene).toContain('rightPageMaterial.uniforms.uProgress.value = pageTurn');
    expect(bookScene).not.toContain('nextLeftPageMaterial');
    expect(bookScene).not.toContain('swapRibbon');
    expect(bookScene).not.toContain('setMaterialMap');
    expect(bookScene).toContain('THREE.FrontSide');
    expect(bookScene).not.toContain('THREE.BackSide');
    expect(bookScene).not.toContain('blankPageMaterial');
    expect(bookScene).not.toContain('turningPagePivot');
    expect(bookScene).not.toContain('.rotation.y');
    ...
    expect(bookArtwork).toContain('const RUNES_PAGE_SLOTS');
    expect(bookArtwork).toContain('const SIGIL_PAGE_SLOTS');
    ...
    expect(bookArtwork).toContain('function drawGraphicPage');
    expect(bookArtwork).toContain('function drawGlyphHeader');
    expect(bookArtwork).toContain('const surface = context.createLinearGradient');
    expect(bookArtwork).toContain("context.strokeStyle = '#0b0c0f'");
    expect(bookArtwork).toContain('GRIMOIRE_GOLD_BRIGHT');
    expect(bookArtwork).not.toContain("'#f2e9d2'");
    expect(bookArtwork).not.toContain('const stain');
    expect(bookArtwork).not.toContain('fiberWidth');
    expect(bookArtwork).toContain('function drawRuneEntry');
    expect(bookArtwork).toContain('function drawRunesPage');
    expect(bookArtwork).toContain('function drawSigilPage');
    expect(bookArtwork).toContain('function drawArcaneRule');
    expect(bookArtwork).not.toContain('INCANTATION_FRAGMENTS');
    expect(bookArtwork).not.toContain('roundedRectPath(context, 78, 88');
    expect(bookArtwork).toContain('context.fillText(title, 256, 124');
    expect(bookArtwork).toContain("Georgia, 'Times New Roman', serif");
    expect(bookArtwork).not.toContain('Palatino Linotype');
    ...
    expect(bookArtwork).toContain('context.clip()');
    expect(bookArtwork).toContain('export function traceBookIconPage');
    expect(bookMotion).toContain('export interface IconBookTransitionPose');
    expect(bookMotion).not.toContain('BOOK_PAGE_COUNT');
