...
describe('spell library UI structure', () => {
  ...
  it('uses a full-width scrollable list with editing in a modal dialog', () => {
    ...
    expect(component).toContain("t('library.emptyRecommendationsLead')");
    expect(component).toContain("t('library.emptyRecommendationsTail')");
    ...
    expect(component).toContain("'spellbook:recommendation-empty-intro-seen'");
    expect(component).toContain('RECOMMENDATION_MESSAGE_DELAY_MS');
    expect(component).toContain('RECOMMENDATION_READY_DELAY_MS');
    expect(component).toContain('window.sessionStorage.setItem');
    ...
    expect(component).toContain('candidate-memory-page-left');
    expect(component).toContain('candidate-memory-page-right');
    expect(component).toContain('candidate-memory-cover-left');
    expect(component).toContain('candidate-memory-page-stack-left');
    expect(component).toContain('candidate-memory-ai-seal');
    expect(component).toContain('candidate-memory-model-map');
    expect(component).toContain('推理回响');
    expect(component).toContain('记忆召回');
    expect(component).toContain('向量共鸣');
    expect(component).toContain('智能体觉醒');
    expect(component).not.toContain('candidate-memory-history-line');
    expect(component).toContain('candidate-memory-searchlight');
    expect(component).toContain('candidate-memory-phrase-lead');
    expect(component).toContain('candidate-memory-phrase-tail');
    ...
    expect(styles).toContain('@keyframes candidate-memory-book-arrive');
    expect(styles).toContain('@keyframes candidate-memory-cover-left-open');
    expect(styles).toContain('@keyframes candidate-memory-cover-right-open');
    expect(styles).toContain('@keyframes candidate-memory-page-left-open');
    expect(styles).toContain('@keyframes candidate-memory-page-right-open');
    expect(styles).toContain('@keyframes candidate-memory-spell-awaken');
    expect(styles).toContain('@keyframes candidate-memory-spell-breathe');
    expect(styles).toContain('@keyframes candidate-memory-search');
    expect(styles).toContain('@keyframes candidate-memory-message');
    expect(styles).toContain('@keyframes candidate-memory-action-arrive');
    expect(styles).toContain('@media (prefers-reduced-motion: reduce)');
    expect(styles).not.toContain('@keyframes candidate-memory-history-flow');
